...
int main (){
	...
	double dt = 1/3; // Le pas de temps, c'est à dire la fraction que représente un jour par rapport à 5000 ans.
	...
	*/
	...
	cout << "vitesse_jupiter_y : " << 13070/(149597870700*24*60*60) << endl;

	for(int i= 1; i<=3; i++){//1825000
