...
int main (){
	...
	double  G = G_original	* pow((1/1.989e30),2) * pow(AU,3);

	double const period = 5000; // Temps en année.
	double dt = 1; // Le pas de temps, c'est à dire la fraction que représente un jour par rapport à 5000 ans.
